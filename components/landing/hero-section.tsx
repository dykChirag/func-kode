 ...
 *
 * CTA wiring (Issue #127):
 *   Primary CTA  → HeroCTA (auth-aware client component): /auth/login or /dashboard
 *   Secondary CTA → https://github.com/patchid/func-kode (new tab, GITHUB_FORK_CLICKED event)
 */
        ...
        >
          ...
          */}
          <div
            ...
            "
          >
            {/* Primary CTA — auth-aware white pill (Issue #127) */}
            <HeroCTA
              className="
            ...
            {/* Secondary CTA — opens GitHub repo in new tab (Issue #127) */}
            <a
