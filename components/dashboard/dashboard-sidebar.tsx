  ...
  return (
    <>
      ...
      {isMobile && (
        ...
        >
          {/* Mobile Header (fixed, doesn't scroll) */}
          <div style={{
          ...
          {/* Divider (fixed, doesn't scroll) */}
          <div style={{ flexShrink: 0, display: "flex", justifyContent: "center", marginBottom: 12, marginLeft: 16, marginRight: 16 }}>
          ...
          {/* Scrollable nav items + bottom sections */}
          <div className="sidebar-scrollbar" style={{
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
              ...
              {/* Bottom section (Logout + Need Help Card) placed inside scrollable container */}
              <div style={{ marginTop: 40, paddingBottom: 16 }}>
                {/* Logout Button */}
                <button className="logout-btn" onClick={handleLogout} style={{
                  width: "100%", height: 35, background: "linear-gradient(180deg, #470137 0%, #DC395F 100%)",
                  border: "none", borderRadius: 12, cursor: "pointer", color: "#FFF", fontWeight: 700,
                  display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 40,
                  fontSize: 12, fontFamily: poppins.style.fontFamily,
                }}>
                  Log Out
                </button>
                ...
                <div style={{ position: "relative", width: 218, height: 170, margin: "0 auto" }}>
                  <svg width="218" height="170" viewBox="0 0 218 170" fill="none" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <foreignObject x="6.00009" y="108.5" width="206" height="55">
                      <div style={{ backdropFilter: "blur(5px)", WebkitBackdropFilter: "blur(5px)", clipPath: "url(#bgblur_0_158_2370_clip_path_mobile)", height: "100%", width: "100%" }} />
                    </foreignObject>
