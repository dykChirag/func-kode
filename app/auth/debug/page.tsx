  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className="mt-6 space-x-4">
        <Link href="/auth/login" className="bg-blue-500 text-white px-4 py-2 rounded inline-block">
          Login
        </Link>
        <Link href="/dashboard" className="bg-green-500 text-white px-4 py-2 rounded inline-block">
          Dashboard
        </Link>
